...
#run_ranges_periods_mixing_2018[ "2018ABCD" ]  = (315252,325273)
...
def process_data_protons_multiRP( lepton_type, data_sample, df_protons_multiRP, df_ppstracks=None, apply_fiducial=True, within_aperture=False, random_protons=False, mix_protons=False, calculate_vars_pp=True, select_2protons=True, runOnMC=False, use_hash_index=False, nprot_value=5 ):

...
set OUTPUT=/eos/home-m/malvesga/SWAN_projects/Antonio_UL/output_12-07
###
...
echo 'Running...'
echo python3 $EXEC/create_table_data_random_protons.py $option1 $option2 $option3 $option4
python3 $EXEC/create_table_data_random_protons.py $option1 $option2 $option3 $option4
cp *.h5 $OUTPUT

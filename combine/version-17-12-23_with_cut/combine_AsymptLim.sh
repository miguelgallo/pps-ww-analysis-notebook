...
combine -M AsymptoticLimits datacard_counting_2018-AQGC-ACW8e-6.txt --run blind --name aCW8e6 -m 80
...
python plotLimitsAQGC.py limits_a0W.json --show exp --logy --x-title '|a^{W}_{0}/#Lambda^{2} (#times 10^{-7} GeV^{-2})|'; mv limit.png limit_a0W.png; mv limit.pdf limit_a0W.pdf
python plotLimitsAQGC.py limits_aCW.json --show exp --logy --x-title '|a^{W}_{C}/#Lambda^{2} (#times 10^{-7} GeV^{-2})|'; mv limit.png limit_aCW.png; mv limit.pdf limit_aCW.pdf

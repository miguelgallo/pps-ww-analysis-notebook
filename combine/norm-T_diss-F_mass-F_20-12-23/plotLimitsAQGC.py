...
parser.add_argument(
    '--x-title', default='a^{C}_{W}/#Lambda^{2} (#times 10^{-7} GeV^{-2})', help="""Title for the x-axis""")
parser.add_argument(
    '--y-title', default='\^{\sigma}(\gamma\gamma \rightarrow WW) (fb)', help="""Title for the y-axis""")
parser.add_argument(
...
plot.FixBothRanges(pads[0], y_min, 0.06, y_max, 0.33)

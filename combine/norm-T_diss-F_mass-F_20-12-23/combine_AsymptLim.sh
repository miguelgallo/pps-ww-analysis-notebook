...
python plotLimitsAQGC.py limits_a0W.json --show exp --logy --x-title '|a^{W}_{0}/#Lambda^{2} (#times 10^{-7} GeV^{-2})|' --y-title '\^{\sigma}(\gamma\gamma \rightarrow WW \rightarrow jj\ell\nu) (fb)'; mv limit.png limit_a0W.png; mv limit.pdf limit_a0W.pdf
python plotLimitsAQGC.py limits_aCW.json --show exp --logy --x-title '|a^{W}_{C}/#Lambda^{2} (#times 10^{-7} GeV^{-2})|' --y-title '\^{\sigma}(\gamma\gamma \rightarrow WW \rightarrow jj\ell\nu) (fb)'; mv limit.png limit_aCW.png; mv limit.pdf limit_aCW.pdf

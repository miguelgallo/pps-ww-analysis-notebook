...
process_data_ = ProcessData( labels=labels_signals, fileNames=fileNames_signals, runOnMC=True )
...
process_data_mix_protons_ = ProcessData( labels=labels_signals_mix_protons, fileNames=fileNames_signals_mix_protons, runOnMC=True )

process_data_( apply_fiducial=True, within_aperture=True, select_2protons=False )

process_data_mix_protons_( apply_fiducial=True, within_aperture=True, mix_protons=True, select_2protons=False )

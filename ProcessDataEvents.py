...
class ProcessDataEvents:
    ...
    def calculateElectrons( self, df ):
        ...
        if self.runOnMC_:
            ...
            #electron_scale_factor_ID_ = ElectronIDScaleFactor(
            #    histos={ "EleID": file_eff_EleID_.Get( histName_EleID_ ),
            #             "EleID_stat": file_eff_EleID_.Get( histName_EleID_ + "_stat" ),
            #             "EleID_syst": file_eff_EleID_.Get( histName_EleID_ + "_syst" ) }
            #    )
            ...
            #electron_scale_factor_TRG_ = ElectronTRGScaleFactor(
            #    histos={ "EleTRG": file_eff_EleTRG_.Get( histName_EleTRG_ ),
            #             "EleTRG_stat": file_eff_EleTRG_.Get( histName_EleTRG_ + "_stat" ),
            #             "EleTRG_syst": file_eff_EleTRG_.Get( histName_EleTRG_ + "_syst" ) }
            #    )

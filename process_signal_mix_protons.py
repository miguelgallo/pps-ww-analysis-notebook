...
# output_dir_=""
output_dir_="output"
process_data_mix_protons_ = ProcessData( lepton_type=lepton_type, data_sample=data_sample, labels=labels_signals_mix_protons_, fileNames=fileNames_signals_mix_protons_, mix_protons=True, runOnMC=True, output_dir="output", use_hash_index=use_hash_index_ )

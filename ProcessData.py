...
class ProcessData:
    def __init__( self, labels, fileNames, runOnMC=False ):
        self.labels_ = labels
    ...
    def __call__( self, apply_fiducial=True, within_aperture=False, random_protons=False, mix_protons=False, select_2protons=True ):
